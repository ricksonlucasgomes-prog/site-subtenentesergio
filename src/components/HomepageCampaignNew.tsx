...
const priorities = [
  { title: "Seguranca", text: "Combate firme ao crime, inteligencia operacional e defesa objetiva de quem vive sob pressao nas ruas." },
  { title: "Valorizacao", text: "Respeito, estrutura e reconhecimento para os profissionais que sustentam a seguranca publica com disciplina e coragem." },
  { title: "Familia", text: "Protecao da familia, educacao com valores e politicas publicas que reforcem estabilidade social e responsabilidade coletiva." },
  { title: "Ordem", text: "Autoridade responsavel, compromisso com a lei e direcao firme para devolver previsibilidade ao pais." },
];
...
const trajectoryItems: TrajectoryItem[] = [
  ...
  },
  {
    ...
    alt: "Subtenente Sergio em representacao institucional",
  },
  {
    title: "Igreja",
    label: "Comunidade",
...
const longVideos = [
  { title: "Entrevista completa: prioridades para Brasilia.", youtubeUrl: "https://www.youtube.com/watch?v=video-placeholder-1" },
  { title: "Propostas para seguranca publica em profundidade.", youtubeUrl: "https://www.youtube.com/watch?v=video-placeholder-2" },
  { title: "Defesa da categoria policial: plano de acao.", youtubeUrl: "https://www.youtube.com/watch?v=video-placeholder-3" },
];

export default function HomepageCampaignNew() {
  ...
  return (
    <main className="overflow-hidden bg-[linear-gradient(180deg,#02040a_0%,#07101c_46%,#04070d_100%)] text-white">
      <header className="sticky top-0 z-50 border-b border-white/8 bg-[rgba(2,5,11,0.72)] backdrop-blur-xl">
          ...
          <div className="flex items-center justify-between gap-6">
            <a href="#topo" className="flex items-center">
              <Image
                ...
                sizes="(max-width: 640px) 114px, 156px"
                className="h-auto w-[6.8rem] object-contain sm:w-[8.2rem]"
              />
            </a>
            <nav className="hidden items-center gap-7 lg:flex">
              <a href="#prioridades" className="text-[11px] font-semibold uppercase tracking-[0.22em] text-white/62 transition-colors hover:text-white">Prioridades</a>
              <a href="#trajetoria" className="text-[11px] font-semibold uppercase tracking-[0.22em] text-white/62 transition-colors hover:text-white">Trajetoria</a>
              <a href="#conteudos" className="text-[11px] font-semibold uppercase tracking-[0.22em] text-white/62 transition-colors hover:text-white">Conteudos</a>
              <a href="#apoie" className="text-[11px] font-semibold uppercase tracking-[0.22em] text-white/62 transition-colors hover:text-white">Apoie</a>
            </nav>
            <a href="#apoie" className={buttonStyles("primary", "px-5.5 py-3 text-[10px] font-black uppercase tracking-[0.24em]")}>Quero apoiar</a>
          </div>
        </Container>
      </header>

      <section id="topo" className="relative overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_76%_18%,rgba(255,223,0,0.17),transparent_22%),radial-gradient(circle_at_18%_22%,rgba(27,151,88,0.1),transparent_18%)]" />
        <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(3,7,12,0.96)_0%,rgba(3,7,12,0.88)_36%,rgba(3,7,12,0.42)_64%,rgba(3,7,12,0.76)_100%)]" />
        <Container className="relative z-10 py-18 sm:py-22 lg:py-26">
          <div className="grid items-center gap-14 lg:grid-cols-[0.86fr_1.14fr] lg:gap-18">
            <div className="max-w-[38rem]">
              <Badge className="border-primary/22 bg-primary/10 px-4 py-2 text-white">Campanha 2026 | Representacao com firmeza</Badge>
              <h1 className="mt-8 max-w-[10.3ch] text-[clamp(3.4rem,8vw,7rem)] font-black uppercase leading-[0.86] tracking-[-0.08em] text-white">
                GOIAS PRECISA DE VOZ FIRME, PRESENCA E AUTORIDADE.
              </h1>
              <p className="mt-7 max-w-[33rem] text-[1.06rem] leading-[1.88] text-white/74 sm:text-[1.15rem]">
              ...
              <div className="mt-10 flex flex-col gap-3 sm:flex-row">
                <a href="#apoie" className={buttonStyles("primary", "px-7.5 py-4 text-[11px] font-black uppercase tracking-[0.24em]")}>Quero apoiar</a>
                <a href="#trajetoria" className={buttonStyles("secondary", "px-7.5 py-4 text-[11px] font-black uppercase tracking-[0.24em]")}>Ver trajetoria</a>
              </div>
            </div>
            <div className="relative">
              <div className="absolute inset-x-[8%] top-[10%] h-[78%] rounded-[2.4rem] bg-primary/12 blur-3xl" />
              <div className="relative overflow-hidden rounded-[2rem] border border-white/8 bg-[linear-gradient(180deg,rgba(255,255,255,0.08),rgba(255,255,255,0.02))] shadow-[0_36px_92px_rgba(0,0,0,0.3)]">
                <div className="relative min-h-[26rem] sm:min-h-[36rem] lg:min-h-[44rem]">
                  ...
                  <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(4,8,14,0.04),rgba(4,8,14,0.12)_40%,rgba(4,8,14,0.84)_100%)]" />
                  <div className="absolute inset-x-0 bottom-0 px-6 py-6 sm:px-8 sm:py-8">
                    ...
                    <p className="mt-3 max-w-[21rem] text-[1.54rem] font-black uppercase leading-[0.96] tracking-[-0.045em] text-white sm:text-[2.06rem]">
      ...
      <section className="border-y border-white/8 bg-[radial-gradient(circle_at_50%_0%,rgba(255,223,0,0.14),transparent_32%),linear-gradient(180deg,rgba(19,31,49,0.98),rgba(10,17,28,0.99))]">
          ...
          <div className="grid gap-0 sm:grid-cols-2 xl:grid-cols-4">
            {stats.map((stat, index) => (
              <div key={stat.label} className={`px-5 py-6 sm:px-6 sm:py-7 lg:px-8 ${index > 0 ? "sm:border-l sm:border-white/8" : ""}`}>
                <p className="text-[4.15rem] font-black leading-none tracking-[-0.12em] text-white sm:text-[5rem] lg:text-[5.6rem]">
      ...
      <Section id="prioridades" className="bg-transparent py-18 sm:py-22">
        <div className="grid gap-12 lg:grid-cols-[0.66fr_1.34fr] lg:gap-18">
          <div className="max-w-[24rem]">
            <Badge className="border-primary/20 bg-transparent px-4 py-2 text-white">Prioridades</Badge>
            <h2 className="mt-6 text-[2.2rem] font-black uppercase leading-[0.96] tracking-[-0.05em] text-white sm:text-[3.15rem]">Direcao clara para a campanha.</h2>
            <p className="mt-5 text-[1rem] leading-[1.8] text-white/68">Compromissos objetivos, leitura politica clara e prioridades que organizam a campanha em torno do que realmente importa.</p>
          </div>
          <div className="space-y-6">
            {priorities.map((item) => (
              <article key={item.title} className="border-b border-white/8 pb-5">
                <h3 className="text-[1.45rem] font-black uppercase tracking-[-0.04em] text-white sm:text-[1.78rem]">{item.title}</h3>
      ...
      <Section id="trajetoria" className="bg-[linear-gradient(180deg,rgba(255,255,255,0.02),rgba(255,255,255,0))] py-18 sm:py-22">
        <div className="grid items-center gap-12 lg:grid-cols-[0.88fr_1.12fr] lg:gap-18">
          <div className="max-w-[34rem]">
            ...
            <h2 className="mt-6 text-[2.2rem] font-black uppercase leading-[0.96] tracking-[-0.05em] text-white sm:text-[3.15rem]">Uma vida publica construida no servico e na representacao.</h2>
          ...
          <div className="grid gap-6 sm:grid-cols-[1.1fr_0.9fr]">
            <div className="relative min-h-[27rem] overflow-hidden rounded-[1.7rem] border border-white/8 shadow-[0_28px_72px_rgba(0,0,0,0.24)]">
      ...
      <Section className="bg-transparent py-18 sm:py-22">
        <div className="grid items-start gap-10 lg:grid-cols-[0.6fr_1.4fr] lg:gap-18">
          <div className="max-w-[24rem]">
          ...
          <div className="overflow-hidden rounded-[1.6rem] border border-white/8 bg-black shadow-[0_30px_70px_rgba(0,0,0,0.28)]">
      ...
      <Section className="bg-[linear-gradient(180deg,rgba(255,255,255,0.02),rgba(255,255,255,0))] py-18 sm:py-22">
        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-2">
          {testimonials.map((item) => (
            <article key={item.signature} className="border-t border-white/8 pt-6">
              <p className="text-[1.08rem] leading-[1.82] text-white/84 sm:text-[1.16rem]">&quot;{item.text}&quot;</p>
              <div className="mt-5">
      ...
      <Section id="conteudos" className="bg-transparent py-18 sm:py-22">
        <div className="grid gap-10 lg:grid-cols-[1.04fr_0.96fr] lg:gap-16">
          <div className="space-y-6">
            <div className="overflow-hidden rounded-[1.5rem] border border-white/8 bg-black shadow-[0_28px_62px_rgba(0,0,0,0.24)]">
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            {shorts.slice(1).map((short) => (
              <article key={short.youtubeId} className="space-y-4">
          ...
          <div className="lg:col-span-2 lg:border-t lg:border-white/8 lg:pt-8">
            <div className="grid gap-5 lg:grid-cols-3">
              {longVideos.map((video) => (
                <a key={video.youtubeUrl} href={video.youtubeUrl} target="_blank" rel="noopener noreferrer" className="group border-b border-white/8 pb-5 transition-colors hover:border-primary/40">
                  <p className="text-[10px] font-semibold uppercase tracking-[0.24em] text-white/42">Conteudo de campanha</p>
                  <p className="mt-3 text-[1.08rem] font-black uppercase leading-[1.16] tracking-[-0.03em] text-white transition-colors group-hover:text-primary">{video.title}</p>
                </a>
              ))}
            </div>
          </div>
      ...
      <Section id="apoie" className="bg-[radial-gradient(circle_at_12%_16%,rgba(255,223,0,0.14),transparent_22%),linear-gradient(180deg,rgba(19,31,49,0.96),rgba(9,16,26,0.98))] py-18 sm:py-22">
        <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16">
          ...
          <div className="rounded-[1.5rem] border border-white/8 bg-[linear-gradient(180deg,rgba(255,255,255,0.05),rgba(255,255,255,0.02))] px-5 py-6 shadow-[0_24px_56px_rgba(0,0,0,0.22)] sm:px-7 sm:py-8">
            <form onSubmit={handleSubmit} className="space-y-5" noValidate>
              <div>
                <label htmlFor="nome-new" className="mb-2 block text-[11px] font-semibold uppercase tracking-[0.18em] text-white/62">Nome</label>
                <input id="nome-new" name="nome" value={formData.nome} onChange={(event) => setFormData((prev) => ({ ...prev, nome: event.target.value }))} className="w-full border-0 border-b border-white/16 bg-transparent px-0 py-4 text-sm text-white outline-none placeholder:text-white/24 focus:border-primary" placeholder="Seu nome completo" />
                {errors.nome ? <p className="mt-1 text-xs text-red-300">{errors.nome}</p> : null}
              </div>
              <div>
                <label htmlFor="whatsapp-new" className="mb-2 block text-[11px] font-semibold uppercase tracking-[0.18em] text-white/62">WhatsApp</label>
                <input id="whatsapp-new" name="whatsapp" value={formData.whatsapp} onChange={(event) => setFormData((prev) => ({ ...prev, whatsapp: event.target.value }))} className="w-full border-0 border-b border-white/16 bg-transparent px-0 py-4 text-sm text-white outline-none placeholder:text-white/24 focus:border-primary" placeholder="(62) 99999-9999" />
                {errors.whatsapp ? <p className="mt-1 text-xs text-red-300">{errors.whatsapp}</p> : null}
              </div>
              <div>
                <label htmlFor="cidade-new" className="mb-2 block text-[11px] font-semibold uppercase tracking-[0.18em] text-white/62">Cidade</label>
                <input id="cidade-new" name="cidade" value={formData.cidade} onChange={(event) => setFormData((prev) => ({ ...prev, cidade: event.target.value }))} className="w-full border-0 border-b border-white/16 bg-transparent px-0 py-4 text-sm text-white outline-none placeholder:text-white/24 focus:border-primary" placeholder="Sua cidade" />
      ...
      <footer className="border-t border-white/8 bg-[rgba(4,8,14,0.96)]">
        <Container className="py-10 sm:py-12">
          <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-[26rem]">
              <Image src={OFFICIAL_LOGO_SRC} alt="Logo oficial Subtenente Sergio" width={OFFICIAL_LOGO_WIDTH} height={OFFICIAL_LOGO_HEIGHT} sizes="(max-width: 640px) 160px, 200px" className="h-auto w-[10rem] object-contain sm:w-[11.5rem]" />
