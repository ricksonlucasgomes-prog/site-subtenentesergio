        ...
        <GlassCard ref={sectionRef} data-reveal className="overflow-hidden rounded-3xl p-6 md:p-8">
          ...
          <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-4 md:gap-0">
            {STATS.map((stat, index) => (
              <div key={stat.label} data-reveal style={revealDelayStyle(index * 80)} className={`rounded-2xl border border-[var(--stroke)] bg-white/[0.03] p-4 text-center transition-transform duration-300 hover:-translate-y-0.5 hover:border-[rgba(255,223,0,0.3)] hover:shadow-[0_0_40px_rgba(13,124,53,0.12)] md:rounded-none md:border-y-0 md:border-r-0 md:px-6 md:py-4 ${index > 0 ? "md:border-l md:border-border-strong" : "md:border-transparent"}`}>
  ...
  return (
    <CinematicBackground>
      <main className="relative z-10 min-h-screen overflow-hidden text-foreground">
            ...
            <div className="flex h-[68px] items-center justify-between gap-3 rounded-[1.6rem] border border-white/10 bg-[linear-gradient(135deg,rgba(5,24,74,0.58),rgba(4,33,96,0.38))] px-4 shadow-[0_16px_32px_rgba(1,7,24,0.24)] ring-1 ring-[rgba(255,255,255,0.05)] md:h-[76px] md:px-6 lg:px-7">
              <div className="flex min-w-0 items-center gap-3 md:gap-4">
                <div className="relative shrink-0">
                  <div aria-hidden className="pointer-events-none absolute inset-[-10%] rounded-full bg-[radial-gradient(circle,rgba(255,255,255,0.08),transparent_68%)] blur-md opacity-60" />
                  <Image src="/logo.svg" alt="Logo oficial Subtenente Sérgio" width={120} height={48} className="relative h-10 w-auto object-contain opacity-90 mix-blend-screen drop-shadow-[0_8px_18px_rgba(0,0,0,0.18)] md:h-11" />
                </div>
        ...
        <Section ref={heroRef} className="relative min-h-[70vh] overflow-hidden border-b border-border !py-0 md:min-h-[78vh]" style={{ "--mx": "50%", "--my": "50%", "--px": "0px", "--py": "0px" } as CSSProperties}>
          <div className="absolute -bottom-10 -left-6 -right-6 -top-6 z-0 md:-bottom-14 md:-left-10 md:-right-10 md:-top-10" style={isCoarsePointer || prefersReducedMotion ? undefined : { transform: "translate3d(var(--px), var(--py), 0)", transition: "transform 120ms linear" }}>
          ...
          <div aria-hidden className="pointer-events-none absolute inset-0 z-10 overlay-breathe">
            <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(3,11,31,0.82)_0%,rgba(4,16,48,0.62)_42%,rgba(4,16,48,0.14)_100%)]" />
            <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(1,8,23,0.18)_0%,rgba(1,8,23,0.04)_20%,rgba(1,8,23,0.44)_100%)]" />
          ...
          <div className="pointer-events-none absolute right-4 top-5 z-20 sm:right-8 sm:top-8">
            <GlassCard className="w-[198px] border-white/10 bg-[var(--glass)] p-3.5 shadow-[0_18px_36px_rgba(0,0,0,0.24)] backdrop-blur-xl sm:w-[240px] sm:p-4">
              ...
              <div className="mt-3 flex items-center gap-2"><div className="h-[2px] w-12 bg-primary" /><div className="h-[2px] flex-1 bg-white/12" /></div>
              <p className="mt-3 text-[11px] font-medium uppercase tracking-[0.16em] text-white/72 sm:text-xs">Presença, ordem e representação</p>
            </GlassCard>
          </div>
          <div className="relative z-20 flex min-h-[70vh] items-end py-16 md:min-h-[78vh] md:py-24">
            <div className="hero-content-reveal max-w-[44rem] space-y-7 md:space-y-9 lg:max-w-[48rem]">
              ...
              <h1 className="max-w-[13ch] text-[40px] font-black uppercase leading-[0.9] tracking-[-0.03em] text-white sm:text-[56px] md:text-[76px]" style={{ textShadow: "0 14px 40px rgba(0,0,0,0.62)" }}>GOIÁS SEGURO<br />EXIGE VOZ FIRME<br />EM <span className="text-accent">BRASÍLIA</span>.</h1>
              <p className="max-w-[38rem] text-base leading-relaxed text-white/78 sm:text-lg md:text-[1.15rem]">Experiência de rua, disciplina institucional e compromisso direto com quem protege as famílias goianas.</p>
              <div className="flex flex-wrap items-center gap-x-4 gap-y-2 text-[11px] font-semibold uppercase tracking-[0.22em] text-white/60 sm:text-xs"><span>Segurança pública</span><span className="h-1 w-1 rounded-full bg-primary" /><span>Valorização policial</span><span className="h-1 w-1 rounded-full bg-primary" /><span>Ordem e família</span></div>
              <div className="flex flex-col gap-3 pt-1 sm:flex-row">
                ...
                <a href="#apoie" className={buttonStyles("secondary", "w-full border-white/16 bg-white/[0.05] px-8 py-4 text-sm font-semibold uppercase tracking-[0.14em] text-white hover:bg-white/[0.08] sm:w-auto")}>Apoiar a campanha</a>
              </div>
            </div>
          </div>
        </Section>
          ...
          <div className="relative">
            ...
            <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                <GlassCard key={item.titulo} data-reveal style={revealDelayStyle(index * 80)} className="group relative overflow-hidden border-white/10 bg-[var(--glass)] p-6 shadow-[0_20px_42px_rgba(0,0,0,0.22)] transition-all duration-300 hover:-translate-y-1 hover:border-primary/35 hover:shadow-[0_24px_52px_rgba(255,223,0,0.08)]">
        ...
        <Section id="trajetoria" className="border-b border-border bg-transparent">
          <div className="relative">
            <div aria-hidden className="pointer-events-none absolute inset-0 -z-10 bg-[radial-gradient(circle_at_top_left,rgba(255,223,0,0.08),transparent_34%),radial-gradient(circle_at_80%_18%,rgba(9,45,124,0.18),transparent_32%),radial-gradient(circle_at_bottom,rgba(6,26,74,0.16),transparent_72%)]" />
            <div className="grid gap-10 lg:grid-cols-[0.92fr_1.08fr] lg:items-center">
              <div className="max-w-xl space-y-5">
                ...
                <GlassCard data-reveal style={revealDelayStyle(140)} className="rounded-[1.8rem] border-white/10 bg-[var(--glass)] p-6">
                  ...
                  <div className="mt-4 grid gap-3 sm:grid-cols-2">
                    {TRAJECTORY_ITEMS.map((item) => (
                      <div key={`summary-${item.title}`} className="rounded-2xl border border-white/10 bg-white/[0.03] px-4 py-3">
              ...
              <div data-reveal style={revealDelayStyle(160)} className="relative isolate overflow-hidden rounded-[2rem] border border-white/10 bg-[var(--panel)] px-4 py-8 shadow-[0_24px_54px_rgba(0,0,0,0.22)] backdrop-blur-[18px] sm:px-6 sm:py-10">
                <div aria-hidden className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_20%_20%,rgba(255,223,0,0.12),transparent_26%),radial-gradient(circle_at_80%_18%,rgba(255,255,255,0.08),transparent_24%),linear-gradient(180deg,rgba(255,255,255,0.04),transparent_42%)]" />
                  ...
                  {TRAJECTORY_ITEMS.map((item, index) => {
                    ...
                    return (
                      <article key={item.title} data-reveal style={revealDelayStyle(180 + index * 70)} className={`group relative flex flex-col items-center text-center ${offsetClass}`}>
                        <div className={`${sizeClass} relative overflow-hidden rounded-full border border-white/14 bg-[linear-gradient(180deg,rgba(255,255,255,0.06),rgba(255,255,255,0.015))] p-2 shadow-[0_18px_42px_rgba(0,0,0,0.2)] ring-1 ring-[rgba(255,255,255,0.05)] transition-transform duration-300 group-hover:-translate-y-1`}>
                        ...
                        <span className="mt-4 rounded-full border border-white/12 bg-white/[0.07] px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.22em] text-white/70">{item.label}</span>
        ...
        <Section className="border-b border-border bg-transparent pt-12 md:pt-16">
          <div className="relative">
            ...
            <GlassCard data-reveal style={revealDelayStyle(120)} className="mx-auto mt-8 w-full max-w-[1280px] overflow-hidden p-3 shadow-[0_22px_52px_rgba(0,0,0,0.28)]">
              ...
              <div>
                ...
                <div className="mt-5 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
                  {shorts.map((short, index) => (
                    <div key={short.youtubeId} data-reveal style={revealDelayStyle(index * 70)} className="group block rounded-2xl border border-border bg-[var(--panel)] p-3 shadow-[0_14px_34px_rgba(0,0,0,0.22)] backdrop-blur-[14px] transition-all duration-300 motion-safe:hover:-translate-y-0.5 hover:border-border-strong hover:shadow-[0_20px_42px_rgba(255,223,0,0.08)]">
                      <div className="relative aspect-[9/16] w-full overflow-hidden rounded-xl border border-border-strong bg-linear-to-b from-card-strong to-background/40 p-4">
              ...
              <div>
                ...
                <div className="mt-5 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
                  {longVideos.map((video, index) => (
                    <a key={video.youtubeUrl} data-reveal style={revealDelayStyle(index * 70)} href={video.youtubeUrl} target="_blank" rel="noopener noreferrer" className="group block rounded-2xl border border-border bg-[var(--panel)] p-3 shadow-[0_14px_34px_rgba(0,0,0,0.22)] backdrop-blur-[14px] transition-all duration-300 motion-safe:hover:-translate-y-0.5 hover:border-border-strong hover:shadow-[0_20px_42px_rgba(255,223,0,0.08)]">
                      <div className="relative aspect-video rounded-xl border border-border-strong bg-linear-to-b from-card-strong to-background/40 p-4">
                        <div aria-hidden className="pointer-events-none absolute inset-0 rounded-xl bg-[linear-gradient(155deg,rgba(255,255,255,0.08)_0%,transparent_55%)]" />
          ...
          <div className="relative">
            ...
            <div className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-start">
              <div data-reveal className="max-w-xl space-y-6 pt-2">
                ...
                <div className="rounded-[1.75rem] border border-white/10 bg-[var(--glass)] p-5 shadow-[0_20px_42px_rgba(0,0,0,0.18)] backdrop-blur-[16px]">
              ...
              <GlassCard data-reveal style={revealDelayStyle(100)} className="border-white/12 bg-[var(--glass)] p-6 shadow-[0_22px_48px_rgba(0,0,0,0.22)] sm:p-7">
                ...
                <form onSubmit={handleSubmit} className="space-y-5" noValidate>
                  <div>
                    ...
                    <input id="nome" name="nome" value={formData.nome} onChange={(event) => setFormData((prev) => ({ ...prev, nome: event.target.value }))} className="w-full rounded-xl border border-white/12 bg-white/[0.045] px-4 py-3 text-sm text-foreground outline-none placeholder:text-white/28 transition-all duration-300 focus:border-primary focus:bg-white/[0.065] focus:ring-2 focus:ring-primary/30" placeholder="Seu nome completo" />
                  ...
                  <div>
                    ...
                    <input id="whatsapp" name="whatsapp" value={formData.whatsapp} onChange={(event) => setFormData((prev) => ({ ...prev, whatsapp: event.target.value }))} className="w-full rounded-xl border border-white/12 bg-white/[0.045] px-4 py-3 text-sm text-foreground outline-none placeholder:text-white/28 transition-all duration-300 focus:border-primary focus:bg-white/[0.065] focus:ring-2 focus:ring-primary/30" placeholder="(62) 99999-9999" />
                  ...
                  <div>
                    ...
                    <input id="cidade" name="cidade" value={formData.cidade} onChange={(event) => setFormData((prev) => ({ ...prev, cidade: event.target.value }))} className="w-full rounded-xl border border-white/12 bg-white/[0.045] px-4 py-3 text-sm text-foreground outline-none placeholder:text-white/28 transition-all duration-300 focus:border-primary focus:bg-white/[0.065] focus:ring-2 focus:ring-primary/30" placeholder="Sua cidade" />
